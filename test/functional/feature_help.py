...
"""Verify that starting memecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start memecoin with -h for help text")
        ...
        self.log.info("Start memecoin with -version for version information")
        ...
        self.log.info("Start memecoind with -fakearg to make sure it does not start")

...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " memecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  memecoin-tx [options] <hex-tx> [commands]  Update hex-encoded memecoin transaction\n" +
            "or:     memecoin-tx [options] -create [commands]   Create hex-encoded memecoin transaction\n" +
            "\n";

...
const char * const BITCOIN_CONF_FILENAME = "memecoin.conf";
const char * const BITCOIN_PID_FILENAME = "memecoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Memecoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Memecoin";
#else
    // Unix
    return pathRet / ".memecoin";
#endif
#endif
}
